...
<body>
        ...
        <div class="container mx-auto px-6">
            <div class="flex justify-between items-center py-5">
                <a href="{{ route('admin.dashboard') }}" class="text-2xl font-black italic tracking-tighter text-blue-500">
                    FOOD<span class="text-white">CART</span> <span class="text-[10px] uppercase tracking-[0.3em] ml-2 text-gray-500 italic">Admin</span>
                </a>
    ...
    <div class="container mx-auto px-6 mt-6">
        @if(session('success'))
            <div class="glass-card bg-green-500/10 border-green-500/20 text-green-400 px-6 py-4 relative mb-4">
